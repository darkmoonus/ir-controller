...
public class DialogAddDevice extends DialogFragment implements OnClickListener {
    ...
    public DialogAddDevice(Context context, DialogAddDeviceListener listener) {
        this.mContext = context;
        this.mInflater = LayoutInflater.from(context);
        this.mListener = listener;
    }

    public static DialogAddDevice newInstance(Context context, DialogAddDeviceListener listener) {
